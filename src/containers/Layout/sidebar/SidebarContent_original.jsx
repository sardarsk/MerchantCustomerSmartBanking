        ...
        <ul className="sidebar__block">
          <SidebarCategory title="SoftPOS" icon="file-add" sidebarCollapse={sidebarCollapse}>
            ...
            <SidebarCategory title="Param Configuration" sidebarCollapse={sidebarCollapse}>
              <SidebarLink title="Register" route="/softpos/merchant/paramconf/registration" onClick={hideSidebar} />
              <SidebarLink title="View" route="/softpos/merchant/paramconf/view" onClick={hideSidebar} />
              <SidebarCategory title="Modify" sidebarCollapse={sidebarCollapse}>
                <SidebarLink title="Entry Point" route="/softpos/merchant/paramconf/entrypoint/modify" onClick={hideSidebar} />
                <SidebarLink title="App List" route="/softpos/merchant/paramconf/applist/modify" onClick={hideSidebar} />
                <SidebarLink title="Rdol" route="/softpos/merchant/paramconf/rdol/modify" onClick={hideSidebar} />
                <SidebarLink title="CapK" route="/softpos/merchant/paramconf/capk/modify" onClick={hideSidebar} />
                <SidebarLink title="Revocation" route="/softpos/merchant/paramconf/revocation/modify" onClick={hideSidebar} />
                <SidebarLink title="Kernel" route="/softpos/merchant/paramconf/kernel/modify" onClick={hideSidebar} />

              </SidebarCategory>
            </SidebarCategory>
            <SidebarCategory title="Keys Configuration" sidebarCollapse={sidebarCollapse}>

              <SidebarCategory title="Register" icon="diamond" sidebarCollapse={sidebarCollapse}>
                <SidebarLink title="Acquirer Key" route="/softpos/merchant/keyConfig/acquirerkey/register" onClick={hideSidebar} />
                <SidebarLink title="Security Key Type" route="/softpos/merchant/keyConfig/securityKeyType/register" onClick={hideSidebar} />
                <SidebarLink title="Security Key" route="/softpos/merchant/keyConfig/securityKey/register" onClick={hideSidebar} />
              </SidebarCategory>
              <SidebarCategory title="Modify" icon="diamond" sidebarCollapse={sidebarCollapse}>
                <SidebarLink title="Acquirer Key" route="/softpos/merchant/keyConfig/acquirerKey/modify" onClick={hideSidebar} />
                <SidebarLink title="Security Key Type" route="/softpos/merchant/keyConfig/securityKeyType/modify" onClick={hideSidebar} />
                <SidebarLink title="Security Key" route="/softpos/merchant/keyConfig/securityKey/modify" onClick={hideSidebar} />
              </SidebarCategory>

              <SidebarCategory title="View" icon="diamond" sidebarCollapse={sidebarCollapse}>
                <SidebarLink title="Acquirer Key" route="/softpos/merchant/keyConfig/acquirerkey/view" onClick={hideSidebar} />
                <SidebarLink title="Security Key Type" route="/softpos/merchant/keyConfig/securityKeyType/view" onClick={hideSidebar} />
                <SidebarLink title="Security Key" route="/softpos/merchant/keyConfig/securityKey/view" onClick={hideSidebar} />
              </SidebarCategory>
            </SidebarCategory>

            <SidebarCategory title="Merchant" sidebarCollapse={sidebarCollapse}>
              <SidebarCategory title="Register" sidebarCollapse={sidebarCollapse}>
                <SidebarLink title="Merchant Onboarding" route="/softpos/merchant/merchant/merReg/register" onClick={hideSidebar} />
                <SidebarLink title="Merchant Receipt" route="/softpos/merchant/merchant/merReceiptReg/register" onClick={hideSidebar} />
              </SidebarCategory>
              <SidebarCategory title="Modify" sidebarCollapse={sidebarCollapse}>
                <SidebarLink title="Merchant Details" route="/softpos/merchant/merchant/merDetails/modify" onClick={hideSidebar} />
                <SidebarLink title="Receipt Details" route="/softpos/merchant/merchant/merReciept/modify" onClick={hideSidebar} />
              </SidebarCategory>
              <SidebarCategory title="View" sidebarCollapse={sidebarCollapse}>
                <SidebarLink title="Merchant Details" route="/softpos/merchant/merchant/merDetails/view" onClick={hideSidebar} />
                <SidebarLink title="Receipt Details" route="/softpos/merchant/merchant/merReciept/view" onClick={hideSidebar} />
              </SidebarCategory>
            </SidebarCategory>
            ...
            <SidebarCategory title="Basic Configuration" sidebarCollapse={sidebarCollapse}>
              ...
              <SidebarCategory title="Theme & Slider Config" sidebarCollapse={sidebarCollapse}>
                <SidebarLink title="Register" route="/softpos/merchant/uiconfigurationtheme/register" onClick={hideSidebar} />
              ...
              <SidebarCategory title="Other Configuration" sidebarCollapse={sidebarCollapse}>
                ...
                <SidebarLink title="Modify" route="/softpos/merchant/uiconfigurationOther/modify" onClick={hideSidebar} />

              </SidebarCategory>
            </SidebarCategory>

            <SidebarCategory title="Terminal Onboarding" sidebarCollapse={sidebarCollapse}>
              <SidebarLink title="Register" route="/softpos/merchant/terminalonboarding/registration" onClick={hideSidebar} />
              <SidebarLink title="Modify" route="/softpos/merchant/terminalonboarding/modify" onClick={hideSidebar} />
              <SidebarLink title="View" route="/softpos/merchant/terminalonboarding/view" onClick={hideSidebar} />
            </SidebarCategory>
            
            <SidebarCategory title="Master" sidebarCollapse={sidebarCollapse}>
              <SidebarCategory title="MCC" sidebarCollapse={sidebarCollapse}>
                <SidebarLink title="Register" route="/softpos/merchant/master/mcc/register" onClick={hideSidebar} />
                <SidebarLink title="Modify" route="/softpos/merchant/master/mcc/modify" onClick={hideSidebar} />
                <SidebarLink title="View" route="/softpos/merchant/master/mcc/view" onClick={hideSidebar} />
              </SidebarCategory>
            ...
            {/* Mobile Brand Config */}
            <SidebarCategory title="Mobile Brand Config" sidebarCollapse={sidebarCollapse}>
              <SidebarLink title="Register" route="/softpos/merchant/master/mcc/register" onClick={hideSidebar} />
              <SidebarLink title="Modify" route="/softpos/merchant/master/mcc/modify" onClick={hideSidebar} />
              <SidebarLink title="View" route="/softpos/merchant/master/mcc/view" onClick={hideSidebar} />
            </SidebarCategory>
            ...
            {/* Mobile SDK Config */}
            <SidebarCategory title="Mobile SDK Config" sidebarCollapse={sidebarCollapse}>
              <SidebarLink title="Register" route="/softpos/merchant/master/mcc/register" onClick={hideSidebar} />
              <SidebarLink title="Modify" route="/softpos/merchant/master/mcc/modify" onClick={hideSidebar} />
              <SidebarLink title="View" route="/softpos/merchant/master/mcc/view" onClick={hideSidebar} />
            </SidebarCategory>

            {/* Mobile Model & OS Config */}
            <SidebarCategory title="Mobile Model & OS Config" sidebarCollapse={sidebarCollapse}>
              <SidebarLink title="Register" route="/softpos/merchant/master/mcc/register" onClick={hideSidebar} />
              <SidebarLink title="Modify" route="/softpos/merchant/master/mcc/modify" onClick={hideSidebar} />
              <SidebarLink title="View" route="/softpos/merchant/master/mcc/view" onClick={hideSidebar} />
            </SidebarCategory>
      ...
      <ul className="sidebar__block">
        <SidebarCategory title="CMS" icon="file-add" sidebarCollapse={sidebarCollapse}>
          ...
          <SidebarCategory title="General Menu" sidebarCollapse={sidebarCollapse}>
            ...
            <SidebarLink title="Generate Card" route="/cms/general/generalMenu/cardHolder/cards&Customers/customers/register" onClick={hideSidebar} />
            ...
            <SidebarLink title="Transaction Limit" route="/cms/generalMenu/cards/transaction-limit" onClick={hideSidebar} />
            <SidebarLink title="Block / Unblock Card" route="/cms/generalMenu/cards/block-unblock-card" onClick={hideSidebar} />
            <SidebarLink title="Reissue Card " route="/cms/generalMenu/cards/reissue-card" onClick={hideSidebar} />
