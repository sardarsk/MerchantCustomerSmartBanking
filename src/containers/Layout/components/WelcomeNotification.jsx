...
const WelcomeNotification = (theme, rtl, setIsNotificationShown, isNotificationShown) => {
  const title = 'Welcome to the Merchant Solution!';
  const message = 'You have successfully logged in. Now you can start using Merchant Solution Application. '
    + 'Enjoy using Merchant Configure, Terminal Configure, Transaction Monitoring, etc..';
  const initialProps = {
