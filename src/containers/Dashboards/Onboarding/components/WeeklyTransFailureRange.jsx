...
const WeeklyTransFailureRange = ({ rtl, themeName }) => {
...
WeeklyTransFailureRange.propTypes = {
  rtl: PropTypes.string.isRequired,
  themeName: PropTypes.string.isRequired,
};

export default connect(state => ({ themeName: state.theme.className }))(WeeklyTransFailureRange);
