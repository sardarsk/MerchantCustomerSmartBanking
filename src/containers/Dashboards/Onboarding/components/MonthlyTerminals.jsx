...
const settingProperty = { color: '#f1fb11', onSlectionColor: '#4ce1b6'}

const MonthlyTerminals = () => {
      ...
      <Card>
        <CardBody className="dashboard__card-widget">
          <div className="card__title">
            <h5 className="bold-text">{t('dashboard_onboarding.monthly_terminal')}</h5>
          </div>
...
export default MonthlyTerminals;
