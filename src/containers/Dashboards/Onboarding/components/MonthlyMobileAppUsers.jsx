...
const settingProperty = { color: '#fd2b11', onSlectionColor: '#4ce1b6'}

const MonthlyMobileAppUsers = () => {
  ...
  return (
    <Col md={12} sm={12} xl={4} lg={12} xs={12}>
      <Card>
        <CardBody className="dashboard__card-widget">
          <div className="card__title">
            <h5 className="bold-text">{t('dashboard_onboarding.monthly_mobile_users')}</h5>
          </div>
...
export default MonthlyMobileAppUsers;
