...
const MonthlyTransFailureRange = ({ rtl, themeName }) => {
  const { t } = useTranslation('common');

  return (
    <Panel lg={12} title={t('dashboard_onboarding.monthly_trans_failuer')}>
      <div dir="ltr">
...
MonthlyTransFailureRange.propTypes = {
  rtl: PropTypes.string.isRequired,
  themeName: PropTypes.string.isRequired,
};

export default connect(state => ({ themeName: state.theme.className }))(MonthlyTransFailureRange);
