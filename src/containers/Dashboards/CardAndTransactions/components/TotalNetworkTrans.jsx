...
const settingProperty = { color: '#e24cc1', onSlectionColor: '#4ce1b6'}

const TotalNetworkTrans = () => {
      ...
      <Card>
        <CardBody className="dashboard__card-widget">
          <div className="card__title">
            <h5 className="bold-text">{t('dashboard_Card_and_trans.total_network_trans')}</h5>
          </div>
...
export default TotalNetworkTrans;
