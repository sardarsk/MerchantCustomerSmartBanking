...
const settingProperty = { color: '#aa1c01', onSlectionColor: '#4ce1b6'}
      ...
      <Card>
        <CardBody className="dashboard__card-widget">
          <div className="card__title">
            <h5 className="bold-text">{t('dashboard_Card_and_trans.total_pos_trans')}</h5>
          </div>
