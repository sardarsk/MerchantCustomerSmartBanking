...
const settingProperty = { color: '#11cf61', onSlectionColor: '#4ce1b6'}

const TotalEcomTrans = () => {
      ...
      <Card>
        <CardBody className="dashboard__card-widget">
          <div className="card__title">
            <h5 className="bold-text">{t('dashboard_Card_and_trans.total_ecom_trans')}</h5>
          </div>
