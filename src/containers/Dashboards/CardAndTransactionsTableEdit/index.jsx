...
const CardAndTransactionsDashboardEdit = ({ dispatch, match }) => {
...
CardAndTransactionsDashboardEdit.propTypes = {
...
export default connect(mapStateToProps)(CardAndTransactionsDashboardEdit);
