...
const Map = ({ mapData }) => {
  ...
  useEffect(() => {
    ...
    label.text = t('vector_map.total_transactions');
    label.fontSize = 12;
    label.align = 'center';
    label.valign = 'bottom';
    ...
    const tooltipFormatter = (target) => {
      ...
      Branches: ${textValue !== '' ? textValue : 0}\n
      Transactions: ${dataContext.deaths ? dataContext.deaths : 0}\n
      Merchant: ${dataContext.recovered ? dataContext.recovered : 0}`;
    };
