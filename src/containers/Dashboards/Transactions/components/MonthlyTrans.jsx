...
const settingProperty = { color: '#48ff61', onSlectionColor: '#4ce1b6'}

const MonthlyTransRange = () => {
      ...
      <Card>
        <CardBody className="dashboard__card-widget">
          <div className="card__title">
            <h5 className="bold-text">{t('dashboard_transactions.monthly_trans')}</h5>
          </div>
...
export default MonthlyTransRange;
