        ...
        <form className="form" onSubmit={handleSubmit}>
          ...
          <div className="form__half">
            <div className="form__form-group">
              ...
              <div className="form__form-group-field">
                <Field name="merchantFooterLine1" validate={[required]} label="Footer Line 1" component={renderField} type="text" placeholder="Enter Footer Line 1" />
          ...
          <div className="form__half">
            <div className="form__form-group">
              ...
              <div className="form__form-group-field">
                <Field name="merchantFooterLine2" validate={[required]} label="Footer Line 2" component={renderField} type="text" placeholder="Enter Footer Line 2" />
          ...
          <div className="form__form-group">
            <div className="form__form-group">
              ...
              <div className="form__form-group-field">
                <Field name="merchantPinEntryMessage" validate={[required]} label="Pin Entry Message" component={renderField} type="text" placeholder="Enter Pin Entry Message" />
              </div>
            </div>
          </div>
          ...
          <div className="form__form-group">
            ...
            <div className="form__form-group-field">
              <div className="payment__credit-card">
                <Field name="merchantPrintRrn" component={renderRadioButtonField} label={<div><p className="payment__credit-name">Yes</p></div>} radioValue="true" defaultChecked />
              </div>
            </div>
            <div className="payment__credit-card">
