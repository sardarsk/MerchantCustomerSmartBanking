...
const ThemeSliderConfigTable = ({ reactTableData }) => {
    ...
    <Col md={12} lg={12}>
      <Card>
        <CardBody>
          ...
          <Row>
            <Col md={12}>
              <h3 className="page-title">Themes & Slider Details</h3>
...
ThemeSliderConfigTable.propTypes = {
...
export default ThemeSliderConfigTable;
