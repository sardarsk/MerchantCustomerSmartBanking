...
const WizardFormOneentryPoint = ({ handleSubmit, previousPage,selectionData }) => {
    var tmsMasterAids = [];
                    ...
                    <div className="form__form-group">
                        <div className="form__form-group">
                            ...
                            <div className="form__form-group-field">
                                <Field name="entryPointTagData" component="input" type="text" placeholder="Enter Tag Data" />
                            </div>
                        </div>
                    </div>
...
WizardFormOneentryPoint.propTypes = {
    handleSubmit: PropTypes.func.isRequired,
};

export default reduxForm({
    form: 'wizard_entry_point', //                 <------ same form name
    destroyOnUnmount: true, //        <------ preserve form data
    forceUnregisterOnUnmount: true, // <------ unregister fields on unmount
})(WizardFormOneentryPoint);
