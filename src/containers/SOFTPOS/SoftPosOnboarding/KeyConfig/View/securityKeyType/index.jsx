...
import CreateTableData from '.././securityKeyType/CreateData';
import { fetchSecurityKeyConfigurationTableData } from '../../actions';
...
const InstitutionTypeEdit = ({ fetchDataAction, tableData }) => {
  ...
  return (
    <Container>
      <Row>
        <Col md={12}>
          <h3 className="page-title">Security Key Type Details</h3>
        </Col>
      </Row>
      {
...
const mapDispatchToProps = {
  fetchDataAction: fetchSecurityKeyConfigurationTableData,
};
