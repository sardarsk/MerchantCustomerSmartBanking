  ...
  return (
    ...
    */}
    ...
    <div className="form__form-group">
      ...
      <div className="form__form-group-field">
        <Field name="registrationNumber" component="input" type="text" placeholder="Registeration Number" />
      </div>
    </div>
    {/* First row */} 
    ...
    <div className="form__SalesInfo">
      <div className="form__form-group">
        <span className="form__form-group-label">Store</span>
        <div className="form__form-group-field">
          <Field
            name="store"
            component={renderSelectField}
            type="text"
            options={[
              { value: 'Madina Dubai', label: 'Madina Dubai' },
              { value: 'Madina Abu', label: 'Madina Abu' },
              { value: 'Madina Sharjah', label: 'Madina Sharjah' },
            ]}
