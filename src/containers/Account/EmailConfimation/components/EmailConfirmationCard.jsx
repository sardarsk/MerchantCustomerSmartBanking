    ...
    <Card>
      <CardBody>
        <div className="email-confirmation">
          ...
          <p className="email-confirmation__sub">Thank you for choosing the MerchantSolutions</p>
          <ButtonToolbar className="email-confirmation__buttons">
            <Link className="btn btn-primary" to="/card_transactions_dashboard">Go to dashboard</Link>
