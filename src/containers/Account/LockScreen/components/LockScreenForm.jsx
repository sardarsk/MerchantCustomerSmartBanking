...
const AccountForm = ({ handleSubmit }) => {
  ...
  return (
    <form className="form" onSubmit={handleSubmit}>
      ...
      <NavLink className="btn btn-primary account__btn" to="/card_transactions_dashboard">Unlock</NavLink>
      <NavLink className="btn btn-outline-danger account__btn" to="/card_transactions_dashboard">Logout</NavLink>
    </form>
  );
};
