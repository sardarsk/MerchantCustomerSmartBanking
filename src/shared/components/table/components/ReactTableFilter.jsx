...
import ExportXLSX from './ReactTableXLSXDownload';
import ExportReactCSV from './ReactTableCSVDownload';

const ReactTableFilter = ({
  rows,
  setGlobalFilter, setFilterValue,
  globalFilter, placeholder, dataLength,data,fileName
}) => {
  ...
  return (
    <div className="table__search">
      ...
      <ExportXLSX csvData={data} fileName={fileName} />
