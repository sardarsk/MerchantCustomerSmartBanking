      ...
      <Card className="card--not-full-height">
        <CardBody>
          <div className="card__title">
            <h5 className="bold-text">{t('KYC file upload')}</h5>
          </div>
          <form className="form" onSubmit={handleSubmit}>
         
            <div className="form__form-group">
              <div className="form__form-group-field">
                <Field name="poaFront" component={renderDropZoneField} />
              </div>
            </div>
            ...
            <div className="form__form-group">
              <div className="form__form-group-field">
                <Field name="poaBack" component={renderDropZoneField} />
              </div>
            </div>
            ...
            <div className="form__form-group">
              <div className="form__form-group-field">
                <Field name="kyc" component={renderDropZoneField} />
              </div>
            </div>
